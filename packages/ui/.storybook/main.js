...
var config = {
    ...
    viteFinal: function (config) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            if (config.resolve) {
                config.resolve.alias = __assign(__assign({}, config.resolve.alias), { "@": (0, path_1.resolve)(__dirname, "../src") });
            }
            // Fix for ES modules and global definitions
            config.define = __assign(__assign({}, config.define), { global: "globalThis" });
